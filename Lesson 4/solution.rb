def sum_even_number_row(row_number)
  ...
  (1..row_number).each do |current_row_number|
    ...
    # ^^ Takes the last number in the last item of array, [rows.length - 1] also works
  end
  rows.last.sum
end
...
# Calculating the start intger:
# Rule: First row of row == Last integer of preceding row + 2
# Algorithm: 
#   - Get the last row of the rows array
#   - Get last integer of said row
...
# 1. reate an empty row to contain the integers
